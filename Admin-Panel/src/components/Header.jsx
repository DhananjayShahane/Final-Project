  ...
  return (
    <>
      <div className="header-2-wrapper">
        <div className="flex items-center">
          <div className="logo flex justify-center">
            <Link to="/" className="hover:none">
              <h2 className="font-medium hover:none text-xl">
                Food<span className="text-orange-400">Hunt</span>
              </h2>
            </Link>
          </div>
          <div className="mx-0 sm:mx-3">
            <button
              className="material-icons menu-toggle cursor-pointer text-gray-500 align-middle focus:outline-none"
              type="button"
            >
              menu
            </button>
          </div>
          <div className="relative text-gray-600 search-bar mx-3">
            <input
          ...
          <div>
            <div className="search-ui">
              <div className="container-fluid">
                <div className="flex justify-between justify-items-center items-center mb-3">
                  <h2 className="text-3xl">
                    Food<span className="text-orange-400">Hunt</span>
                  </h2>
                  <div className="text-right">
                    <button className="search-ui-close btn" type="button">
                      <i className="i-Close-Window text-xl text-gray-600"></i>
                    </button>
                  </div>
                </div>
                <input
                  className="search-input text-5xl md:text-6xl font-semibold"
                  type="text"
        ...
        <div className="flex items-center">
          <button
            className="hidden mr-0 btn btn-sm hover:bg-gray-100 sm:block rounded p-1 md:mr-2"
            data-toggle="dropdown"
          >
            <i className="i-Full-Screen text-gray-800 text-xl"></i>
          </button>
          <div className="mr-0 ul-dropdown md:mr-2">
            <button
              className="btn btn-sm hover:bg-gray-100 rounded-pill badge-top-container p-1"
              data-toggle="dropdown"
            >
              <span className="badge-count text-white bg-orange-500">3</span>
              <i className="i-Bell text-xl header-icon text-gray-800"></i>
            </button>
            <div className="dropdown-menu">
              ...
              >
                <a
                  className="flex justify-between justify-items-center p-3 hover:bg-gray-100 hover:text-gray-700"
                  href="#"
                >
                  <div>
              ...
              <button
                ...
                >
                  ...
                  <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                    <img
                      src="./src/assets/images/faces/user-avtar.png"
